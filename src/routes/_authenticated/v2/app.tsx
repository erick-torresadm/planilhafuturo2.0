...
/* /v2/app — mesma logica de dados de /app (nenhuma regra de negocio
   reescrita), so troca o componente visual (DashboardMercury -> DashboardV2). */
export const Route = createFileRoute("/_authenticated/v2/app")({
  head: () => ({ meta: [{ title: "Hoje — planilhafuturo v2" }] }),
  component: HojePageV2,
});
