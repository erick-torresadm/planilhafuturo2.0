...
/* /v2/historico — mesma logica de dados de /historico (24 meses pra
   tras, mesmo computaMes), visual novo em 2 cards de resumo + lista
   de movimentacoes, no lugar da tabela dia-a-dia. */
export const Route = createFileRoute("/_authenticated/v2/historico")({
  head: () => ({ meta: [{ title: "Histórico — planilhafuturo v2" }] }),
  component: HistoricoPageV2,
});

const BACK = 24;

function HistoricoPageV2() {
  ...
  const mes = useMemo(() => {
    ...
    // anteriores, que fica no /v2/fluxo.
